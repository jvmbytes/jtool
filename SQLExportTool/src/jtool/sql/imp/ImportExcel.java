...
public class ImportExcel {
  ...
  public static void imp(String driverName, String linkUrl, String userName, String password,
      String tableName, String excelFilePath, boolean bulkinsert) throws Exception {
  ...
  public static void imp(Connection connection, String userName, String tableName, File file,
      int sheetIndex, boolean bulkinsert) throws Exception {
    ...
    if (ImportGlobals.isValidFirst()) {
      boolean valid =
          ImportUtil.validateData(connection, userName, tableName, columns, columnMap, dataHolder);
      if (!valid) {
