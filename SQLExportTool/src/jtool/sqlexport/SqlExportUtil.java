...
public class SqlExportUtil {
    ...
    public static StringBuffer exportCSV(ResultSetMetaData rmeta, ResultSet rs) throws SQLException, IOException {
    ...
    public static StringBuffer exportInsert(ResultSetMetaData rmeta, ResultSet rs, String tableName) throws SQLException, IOException {
        int numColumns = rmeta.getColumnCount();
        System.out.println("column count: " + numColumns);
        System.out.println("-------------------------------------");
        for (int i = 1; i <= numColumns; i++) {
